...
class MissionImportData:
    ...
    def __init__(self, mission_items, geofence_items, rally_items):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.geofence_items == to_compare.geofence_items)
                and (self.rally_items == to_compare.rally_items)
            )
