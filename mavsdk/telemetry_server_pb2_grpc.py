...
class TelemetryServerService(object):
    ...
    @staticmethod
    def PublishPositionVelocityNed(
        request,
        target,
        options=(),
        channel_credentials=None,
