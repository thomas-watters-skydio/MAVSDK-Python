...
PlayTuneRequest = _reflection.GeneratedProtocolMessageType(
    "PlayTuneRequest",
    (_message.Message,),
    {
...
PlayTuneResponse = _reflection.GeneratedProtocolMessageType(
    "PlayTuneResponse",
    (_message.Message,),
    {
...
TuneDescription = _reflection.GeneratedProtocolMessageType(
    "TuneDescription",
    (_message.Message,),
    {
...
TuneResult = _reflection.GeneratedProtocolMessageType(
    "TuneResult",
    (_message.Message,),
    {
