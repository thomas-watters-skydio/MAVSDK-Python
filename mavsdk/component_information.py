...
class ComponentInformationResult:
    ...
    class Result(Enum):
        ...
        def translate_from_rpc(rpc_enum_value):
            ...
            if (
                rpc_enum_value
                == component_information_pb2.ComponentInformationResult.RESULT_UNKNOWN
            ):
    ...
    def translate_from_rpc(rpcComponentInformationResult):
        ...
        return ComponentInformationResult(
            ComponentInformationResult.Result.translate_from_rpc(
                rpcComponentInformationResult.result
            ),
