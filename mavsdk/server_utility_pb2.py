...
SendStatusTextRequest = _reflection.GeneratedProtocolMessageType(
...
SendStatusTextResponse = _reflection.GeneratedProtocolMessageType(
...
ServerUtilityResult = _reflection.GeneratedProtocolMessageType(
    "ServerUtilityResult",
    (_message.Message,),
    {
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SERVERUTILITYSERVICE.methods_by_name[
        "SendStatusText"
