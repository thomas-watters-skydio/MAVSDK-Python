...
SubscribeReceiveRequest = _reflection.GeneratedProtocolMessageType(
...
ReceiveResponse = _reflection.GeneratedProtocolMessageType(
    "ReceiveResponse",
    (_message.Message,),
    {
...
ShellResult = _reflection.GeneratedProtocolMessageType(
    "ShellResult",
    (_message.Message,),
    {
