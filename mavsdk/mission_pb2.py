...
_SUBSCRIBEUPLOADMISSIONWITHPROGRESSREQUEST = DESCRIPTOR.message_types_by_name[
    "SubscribeUploadMissionWithProgressRequest"
]
_UPLOADMISSIONWITHPROGRESSRESPONSE = DESCRIPTOR.message_types_by_name[
...
_SUBSCRIBEDOWNLOADMISSIONWITHPROGRESSREQUEST = DESCRIPTOR.message_types_by_name[
    "SubscribeDownloadMissionWithProgressRequest"
]
_DOWNLOADMISSIONWITHPROGRESSRESPONSE = DESCRIPTOR.message_types_by_name[
...
_GETRETURNTOLAUNCHAFTERMISSIONREQUEST = DESCRIPTOR.message_types_by_name[
    "GetReturnToLaunchAfterMissionRequest"
]
_GETRETURNTOLAUNCHAFTERMISSIONRESPONSE = DESCRIPTOR.message_types_by_name[
    "GetReturnToLaunchAfterMissionResponse"
]
_SETRETURNTOLAUNCHAFTERMISSIONREQUEST = DESCRIPTOR.message_types_by_name[
    "SetReturnToLaunchAfterMissionRequest"
]
_SETRETURNTOLAUNCHAFTERMISSIONRESPONSE = DESCRIPTOR.message_types_by_name[
...
SubscribeUploadMissionWithProgressRequest = _reflection.GeneratedProtocolMessageType(
    "SubscribeUploadMissionWithProgressRequest",
    (_message.Message,),
    {
...
UploadMissionWithProgressResponse = _reflection.GeneratedProtocolMessageType(
    "UploadMissionWithProgressResponse",
    (_message.Message,),
    {
...
SubscribeDownloadMissionWithProgressRequest = _reflection.GeneratedProtocolMessageType(
    "SubscribeDownloadMissionWithProgressRequest",
    (_message.Message,),
    {
...
DownloadMissionWithProgressResponse = _reflection.GeneratedProtocolMessageType(
    "DownloadMissionWithProgressResponse",
    (_message.Message,),
    {
...
IsMissionFinishedRequest = _reflection.GeneratedProtocolMessageType(
...
IsMissionFinishedResponse = _reflection.GeneratedProtocolMessageType(
...
GetReturnToLaunchAfterMissionRequest = _reflection.GeneratedProtocolMessageType(
    "GetReturnToLaunchAfterMissionRequest",
    (_message.Message,),
    {
...
GetReturnToLaunchAfterMissionResponse = _reflection.GeneratedProtocolMessageType(
    "GetReturnToLaunchAfterMissionResponse",
    (_message.Message,),
    {
...
SetReturnToLaunchAfterMissionRequest = _reflection.GeneratedProtocolMessageType(
    "SetReturnToLaunchAfterMissionRequest",
    (_message.Message,),
    {
...
SetReturnToLaunchAfterMissionResponse = _reflection.GeneratedProtocolMessageType(
    "SetReturnToLaunchAfterMissionResponse",
    (_message.Message,),
    {
...
MissionPlan = _reflection.GeneratedProtocolMessageType(
    "MissionPlan",
    (_message.Message,),
    {
...
MissionResult = _reflection.GeneratedProtocolMessageType(
    "MissionResult",
    (_message.Message,),
    {
...
ProgressDataOrMission = _reflection.GeneratedProtocolMessageType(
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MISSIONITEM.fields_by_name[
        "latitude_deg"
    ]._serialized_options = b"\202\265\030\003NaN\211\265\030H\257\274\232\362\327z>"
    ...
    _MISSIONITEM.fields_by_name[
        "gimbal_pitch_deg"
    ]._serialized_options = b"\202\265\030\003NaN\211\265\030-C\034\353\3426\032?"
    ...
    ]._serialized_options = b"\202\265\030\0031.0"
    ...
    _PROGRESSDATAORMISSION.fields_by_name[
        "has_progress"
    ...
    _MISSIONSERVICE.methods_by_name[
