...
InjectRequest = _reflection.GeneratedProtocolMessageType(
    "InjectRequest",
    (_message.Message,),
    {
...
InjectResponse = _reflection.GeneratedProtocolMessageType(
    "InjectResponse",
    (_message.Message,),
    {
...
FailureResult = _reflection.GeneratedProtocolMessageType(
    "FailureResult",
    (_message.Message,),
    {
