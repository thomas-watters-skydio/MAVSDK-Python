...
class CameraService(object):
    ...
    @staticmethod
    def SubscribePossibleSettingOptions(
        request,
        target,
        options=(),
        channel_credentials=None,
