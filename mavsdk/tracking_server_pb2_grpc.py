...
class TrackingServerService(object):
    ...
    @staticmethod
    def SubscribeTrackingRectangleCommand(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SubscribeTrackingOffCommand(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def RespondTrackingPointCommand(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def RespondTrackingRectangleCommand(
        request,
        target,
        options=(),
        channel_credentials=None,
