...
class ProgressData:
    ...
    def __init__(self, has_progress, progress, has_status_text, status_text):
    ...
    def __eq__(self, to_compare):
        ...
        try:
            ...
            return (
                ...
                and (self.has_status_text == to_compare.has_status_text)
                and (self.status_text == to_compare.status_text)
            )
...
class Calibration(AsyncBase):
    ...
    async def calibrate_gimbal_accelerometer(self):
        ...
        calibrate_gimbal_accelerometer_stream = self._stub.SubscribeCalibrateGimbalAccelerometer(
            request
        )
