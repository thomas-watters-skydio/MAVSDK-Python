...
class TelemetryService(object):
    ...
    @staticmethod
    def SubscribeAttitudeQuaternion(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SubscribeAttitudeAngularVelocityBody(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SubscribeCameraAttitudeQuaternion(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SubscribeCameraAttitudeEuler(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SubscribeActuatorControlTarget(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SubscribeActuatorOutputStatus(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SubscribePositionVelocityNed(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SetRateActuatorControlTarget(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def SetRateActuatorOutputStatus(
        request,
        target,
        options=(),
        channel_credentials=None,
