...
_SUBSCRIBECONNECTIONSTATEREQUEST = DESCRIPTOR.message_types_by_name[
...
SubscribeConnectionStateRequest = _reflection.GeneratedProtocolMessageType(
    "SubscribeConnectionStateRequest",
    (_message.Message,),
    {
...
ConnectionStateResponse = _reflection.GeneratedProtocolMessageType(
...
SetMavlinkTimeoutRequest = _reflection.GeneratedProtocolMessageType(
...
SetMavlinkTimeoutResponse = _reflection.GeneratedProtocolMessageType(
...
ConnectionState = _reflection.GeneratedProtocolMessageType(
    "ConnectionState",
    (_message.Message,),
    {
